...
const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  ...
  admin: [],
  /**
   * ⚠️ پورتِ **اثرِ واقعیِ** نقشِ ACCOUNTANT در نسخهٔ قبلی، نه فهرستِ capهایش:
   * آنجا Lockdown حسابدار را به دو صفحهٔ حسابداری و پرداخت‌ها محدود می‌کرد و
   * هر آدرسِ دیگری (گزارش‌ها، تنظیمات، فعالیت) او را برمی‌گرداند. پیش از این
   * نقشِ finance اینجا تنظیمات (ارز، تگ، دفتر، QA، سامانه)، گزارش‌ها و فعالیت
   * را هم باز می‌کرد — گسترده‌تر از آنچه حسابدار در افزونه می‌دید. کسی که
   * باید بیشتر ببیند، همکارِ ادمین با دسترسیِ per-user است.
   */
