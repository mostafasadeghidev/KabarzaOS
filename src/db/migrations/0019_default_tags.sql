...
FROM (VALUES
  ...
  ('on-hold', 'task_status', 'متوقف', '#b4cac9', '', 'in_progress', false, false, false, 27, '{"fa": "متوقف", "en": "On Hold", "de": "In der Warteschleife", "ckb": "راگیراوە", "ar": "معلّق", "tr": "Beklemede", "fr": "En attente", "es": "En espera", "pt": "Em espera"}'::jsonb),
