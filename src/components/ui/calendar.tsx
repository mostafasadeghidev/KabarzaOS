...
/**
 * ⚠️ کدِ رسمیِ shadcn (`calendar`, new-york-v4) با اصلاحِ RTL (R-I18N-05):
 * گوشه‌های گردِ ابتدا/انتهای بازه `rounded-l/r` بودند که **فیزیکی** است؛ در
 * فارسی گوشهٔ اولِ بازه سمتِ اشتباه گرد می‌شد. `rounded-s/e` جهت را از صفحه
 * می‌گیرد. چرخشِ فلش‌ها در RTL را خودِ کدِ رسمی دارد.
 */
