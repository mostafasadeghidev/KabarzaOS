 ...
 *   pr-8/pl-2 -> pe-8/ps-2 · right-2 -> end-2 (جای تیکِ گزینهٔ انتخاب‌شده)
 *
 * انیمیشن‌های `slide-in-from-left/right` که با `data-[side=…]` جفت‌اند دست‌نخورده
 * ماندند: آن‌ها به سمتِ فیزیکیِ بازشدنِ منو گره خورده‌اند، نه به چینشِ متن.
 */
"use client"
