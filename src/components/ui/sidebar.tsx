 ...
 *   text-left -> text-start · pr-8 -> pe-8 · ml-0/ml-2 -> ms-0/ms-2
 *
 * موقعیت‌های `left-0`/`right-0` که با `data-[side=…]` جفت‌اند **عمداً** دست‌نخورده
 * ماندند: آن‌ها سمتِ فیزیکیِ خودِ سایدبار را می‌سازند، نه چینشِ محتوا. برای RTL
 * کافی است `side="right"` بدهیم — که در AppSidebar انجام شده.
 */
"use client"
