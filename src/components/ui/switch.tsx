/**
 * ⚠️ کدِ رسمیِ shadcn (`switch`, new-york-v4) با اصلاحِ RTL (R-I18N-05):
 * جابه‌جاییِ دستگیره `translate-x` است که **فیزیکی** است؛ در فارسی دستگیرهٔ
 * روشن باید به چپ برود، نه راست. بدونِ `rtl:` کلید در حالتِ روشن از قابِ
 * خودش بیرون می‌زد.
 */
"use client"
